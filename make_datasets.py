...
# Import data
data_indicators = pd.read_pickle('incom/datasets/data_indicators.pkl')
data_time_direct = pd.read_pickle('incom/datasets/data_time_direct.pkl')
data_time_organic = pd.read_pickle('incom/datasets/data_time_organic.pkl')
data_time_paid = pd.read_pickle('incom/datasets/data_time_paid.pkl')
data_search_engines = pd.read_pickle('incom/datasets/data_search_engines.pkl')
data_social_networks = pd.read_pickle('incom/datasets/data_social_networks.pkl')
data_paid_sources = pd.read_pickle('incom/datasets/data_paid_sources.pkl')
